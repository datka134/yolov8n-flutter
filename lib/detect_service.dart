...
class Detector {
  static const String _modelPath = 'assets/model/retrained-128.tflite';
...
class _DetectorServer {
  ...
  Map<String, dynamic> analyseImage(
    ...
    //   double top = detection.BoundingBox['origin_x'];
    ...
    //   if (score > confidence) {
    //     detections.add(
    //       Detection(score, boundingBox: boundingBox),
    //     );
    //   }
    // }
  ...
  Map<int, List> _runInference(
    ...
    // final output = {
    //   0: [List<List<num>>.filled(896, List<num>.filled(16, 0))],
    //   1: [List<List<num>>.filled(896, List<num>.filled(1, 0))],
    //   2: [List<num>.filled(10, 0)],
    //   3: [0.0],
    // };
    final output ={0: List.filled(1 * 5 * 336, 0).reshape([1,5,336])};
